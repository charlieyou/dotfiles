...
-- [[ Custom: Per-language indent conventions ]]
...
require('lazy').setup({
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          local function client_supports_method(c, method, bufnr)
            ...
            else return c.supports_method(method, { bufnr = bufnr }) end
          end
  ...
  { -- Custom: Colorscheme (github_dark_default instead of tokyonight)
